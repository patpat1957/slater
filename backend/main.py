...
# Comprehensive mapping — every game from LOTTERIES_BY_STATE grouped by type
SCOREBOARD_GAMES = {
    "pick3": {
        ...
        "CO": {"evening": "co_pick3"},
        "CT": {"evening": "ct_play3"},
        "DE": {"evening": "de_play3_night", "midday": "de_play3_day"},
        "IA": {"evening": "ia_pick3_evening", "midday": "ia_pick3_midday"},
        "ID": {"evening": "id_pick3_night", "midday": "id_pick3_day"},
        "KS": {"evening": "ks_pick3_evening", "midday": "ks_pick3_midday"},
        "ME": {"evening": "me_pick3"},
        "MN": {"evening": "mn_pick3"},
        "MS": {"evening": "ms_cash3", "midday": "ms_cash3_midday"},
        "NE": {"evening": "ne_pick3"},
        "NH": {"evening": "nh_pick3"},
        "NM": {"evening": "nm_pick3"},
        "OK": {"evening": "ok_pick3"},
        "RI": {"evening": "ri_numbers"},
        "SD": {"evening": "sd_pick3"},
        "VT": {"evening": "vt_pick3"},
        "WA": {"evening": "wa_daily_game"},
    },
    "pick4": {
        ...
        "WI": {"evening": "wi_pick4"},
        "CA": {"evening": "ca_daily4"},
        "CT": {"evening": "ct_play4"},
        "DC": {"evening": "dc_lottery"},
        "DE": {"evening": "de_play4_night", "midday": "de_play4_day"},
        "IA": {"evening": "ia_pick4_evening", "midday": "ia_pick4_midday"},
        "ID": {"evening": "id_pick4_night", "midday": "id_pick4_day"},
        "ME": {"evening": "me_pick4"},
        "MS": {"evening": "ms_cash4", "midday": "ms_cash4_midday"},
        "NH": {"evening": "nh_pick4"},
        "OR": {"evening": "or_pick4"},
        "TN": {"evening": "tn_pick4"},
        "VT": {"evening": "vt_pick4"},
        "WA": {"evening": "wa_match4"},
    },
    "pick5": {
        ...
        "LA": {"evening": "la_pick5"},
        "DE": {"evening": "de_play5_night", "midday": "de_play5_day"},
        "NE": {"evening": "ne_pick5"},
    },
    "cash5": {
        "AZ": {"evening": "az_fantasy5"},
        "CA": {"evening": "ca_fantasy5"},
        "CO": {"evening": "co_cash5"},
        "CT": {"evening": "ct_cash5"},
        "FL": {"evening": "fl_fantasy5"},
        "GA": {"evening": "ga_fantasy5", "midday": "ga_five_midday"},
        "IN": {"evening": "in_cash5"},
        "MI": {"evening": "mi_fantasy5"},
        "NC": {"evening": "nc_cash5"},
        "NJ": {"evening": "nj_jersey_cash5"},
        "NY": {"evening": "ny_take5", "midday": "ny_take5_midday"},
        "OH": {"evening": "oh_rolling_cash5"},
        "OK": {"evening": "ok_cash5"},
        "PA": {"evening": "pa_cash5"},
        "SC": {"evening": "sc_palmetto_cash5"},
        "TX": {"evening": "tx_cash5"},
        "VA": {"evening": "va_cash5"},
    },
    "lotto": {
        "NY": {"evening": "ny_lotto"},
        "FL": {"evening": "fl_lotto"},
        "TX": {"evening": "tx_lotto_texas"},
        "IL": {"evening": "il_lotto"},
        "NJ": {"evening": "nj_pick6"},
        "PA": {"evening": "pa_match6"},
        "CA": {"evening": "ca_superlotto_plus"},
    },
    "powerball": {
